...
// Preserves the historical Docusaurus-compatible shape with an optional
// `length` field.
...
export function TabsProvider(props: {
  ...
  // Keep scroll-position blocking available to the swizzled @theme/Tabs
  // without requiring callers to mount another provider.
  return (
